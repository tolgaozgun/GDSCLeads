    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='community_city', to='map.city')),
            ],
        ),
        migrations.CreateModel(
            name='Venue',
            fields=[
                ...
                ('latitude', models.FloatField()),
                ('longitude', models.FloatField()),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='venue_city', to='map.city')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('latitude', models.FloatField()),
                ('longitude', models.FloatField()),
                ('communities', models.ManyToManyField(blank=True, related_name='events', to='map.community')),
                ('venue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event', to='map.venue')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('community', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lead', to='map.community')),
